...
from app.views import DimStudentViewSet, FactWritingDatasetViewSet

router = DefaultRouter()
router.register(r'students', DimStudentViewSet, basename='student')
router.register(r'writing', FactWritingDatasetViewSet, basename='writing')
...
POST /api/writing/ → zapis danych pisma
GET /api/writing/ → lista zapisanych obrazów pisma
"""